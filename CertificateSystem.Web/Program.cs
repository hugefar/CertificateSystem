...
builder.Services.AddScoped<IOraclePaperRepository>(_ => new OraclePaperRepository(builder.Configuration.GetConnectionString("PaperOracleConnection") ?? throw new InvalidOperationException("PaperOracleConnection not found.")));
